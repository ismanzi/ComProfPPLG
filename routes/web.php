...
Route::get('/home', [WebController::class, 'home'])->name('landing.home');
Route::get('/achievement', [WebController::class, 'achievement'])->name('landing.achievement');
Route::get('/about', [WebController::class, 'about'])->name('landing.about');
...
Route::middleware(['auth'])->group(function () {
    ...
    //Routes konfig
    Route::prefix('admin/configs')->group(function () {
