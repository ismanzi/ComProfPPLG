...
@section('link-btn-title')
    <a href="{{ route('pages.admin.comment.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-regular text-primary">Data comment</h6>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($comments as $comment)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('pages.admin.comment.view', $comment->id) }}"
