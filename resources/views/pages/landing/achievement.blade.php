...
@section('content')
    <main class="mt-10 space-y-40 mb-40">
        <div class="relative">
            <br>
            <br>
            <br>
            <div>
                <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6 py-5">
                    <div class="mb-12 space-y-2 text-center">
                        <h2 class="text-3xl font-bold text-gray-800 md:text-4xl dark:text-white">Our Achievement</h2>
                        <p class="lg:mx-auto lg:w-6/12 text-gray-600 dark:text-gray-300">
                            Our achievements highlight outstanding accomplishments in academics and other fields, showcasing
