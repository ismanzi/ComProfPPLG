                ...
                <div
                    ...
                    <div
                        ...
                        <div class="relative space-y-8 py-12 p-8">
                            <img src="{{ asset('baselanding/icons/achievement.png') }}" class="w-12"
                    ...
                    <div
                        class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                        <div class="relative space-y-8 py-12 p-8">
                            <img src="{{ asset('baselanding/icons/staff.png') }}" class="w-12" class="w-12"
                                width="512" height="512" alt="burger illustration">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img src="{{ asset('baselanding/icons/curriculum.png') }}" class="w-12"class="w-12"
                                width="512" height="512" alt="burger illustration">
