                    ...
                    <div
                        ...
                        <div class="text-gray-600 dark:text-gray-300 lg:pr-4 lg:w-auto w-full lg:pt-0">
                            <ul class="tracking-wide font-medium lg:text-sm flex-col flex lg:flex-row gap-6 lg:gap-0">
                                ...
                                <li>
                                    <a href="#"
                                        class="block md:px-4 transition hover:text-primary p-2 rounded">Project</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="block md:px-4 transition hover:text-primary p-2 rounded">News</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="relative pt-36 ml-auto">
                    ...
                    <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
                        ...
                        <div class="mt-12 flex flex-col">
                            <p class="mt-2 text-gray-700 text-lg font-semibold">Our Partner</p>
                            <div class="flex">
                                <div class="p-4 grayscale transition duration-200 hover:grayscale-0">
                                    <img src="{{ asset('baselanding/dist/images/clients/aws.svg') }}"
                                        class="h-12 w-auto mx-auto" loading="lazy" alt="AWS logo">
                                </div>
                                {{-- Add more partner --}}
                            </div>
                        </div>
                ...
                <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
                    ...
                    <div
                        ...
                        <div class="md:5/12 lg:w-1/2">
                            <img src={{ asset('baselanding/images/pie.svg') }} alt="image" loading="lazy"
                        ...
                        <div class="md:7/12 lg:w-1/2">
                            ...
                            <div class="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
                                ...
                                <div class="pt-4 flex gap-4 md:items-center">
                                    ...
                                    <div class="w-5/6">
                                        <h4 class="font-semibold text-lg text-gray-700 dark:text-teal-300">Real Time
                                            Location</h4>
                                        <p class="text-gray-500 dark:text-gray-400">Asperiores nemo possimus nesciunt
                                            quam
                                            mollitia.</p>
                ...
                <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
                    ...
                    <div class="md:columns-2 lg:columns-3 gap-8 space-y-8">
                        <div
                            ...
                            <p class="mt-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum aliquid
                                quo
                        ...
                        <div
                            ...
                            <p class="mt-8"> Lorem ipsum dolor laboriosam deleniti aperiam ab veniam sint non cumque
                                quis
                                tempore cupiditate. Sint libero voluptas veniam at reprehenderit, veritatis harum et
                                rerum.
                            </p>
                        </div>
                        <div
                            ...
                            <p class="mt-8">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Architecto
                                laboriosam deleniti aperiam ab veniam sint non cumque quis tempore cupiditate. Sint
                                libero
                        ...
                        <div
                            ...
                            <div class="flex gap-4">
                                <img class="w-12 h-12 rounded-full"
                                    src={{ asset('baselanding/images/second_user.webp') }} alt=""
                ...
                <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
                    <div class="relative">
                        ...
                        <div class="m-auto space-y-6 md:w-8/12 lg:w-7/12">
                            <h1 class="text-center text-4xl font-bold text-gray-800 dark:text-white md:text-5xl">Get
                                Started now</h1>
                            ...
                            <div class="flex flex-wrap justify-center gap-6">
                                ...
                                <a href="#"
                                    ...
                                    <span class="relative text-base font-semibold text-primary dark:text-white">More
                                        about</span>
                                </a>
                            </div>
                        </div>
