...
<head>
    ...
    <link href={{ asset('baseadmin/vendor/fontawesome-free/css/all.min.css') }} rel="stylesheet" type="text/css">
    <link
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <img src="{{ asset('baseadmin/img/logos/logo_PPLG.png') }}" width="50px" alt="">
            </a>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src={{ asset('baseadmin/img/undraw_posting_photo.svg') }} alt="...">
                                    </div>
